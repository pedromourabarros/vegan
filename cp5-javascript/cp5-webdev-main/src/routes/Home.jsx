...
function Home() {
  ...
  const imagens = [
    ...
    { id: '1', image: './src/assets/vegan1.jpg' },
    { id: '3', image: './src/assets/vegan2.jpg' },
    { id: '2', image: './src/assets/vegan3.jpg' },
  ];
  ...
  return (
    <section>
      ...
      <center>
        <h1 style={{ marginBottom: '20px' }}>Bem vindo ao Restaurante Vegan Planet</h1>
      </center>
